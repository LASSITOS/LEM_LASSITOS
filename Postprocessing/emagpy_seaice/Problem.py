    ...
    def invert(self, forwardModel='CS', method='L-BFGS-B', regularization='l2',
        ...
        def fmodel(p, ini0): # p contains first the depths then the conductivities
            ...
            if forwardModel == 'CS':
                ...
                return np.real(getQs(cond, depth, self.cspacing, self.cpos, f=self.freqs, hx=self.hx))*1e3
        ...
        for i, survey in enumerate(self.surveys):
            ...
            quad = survey.df[self.coilsQuad].values # quadrature in ppt
    ...
    def forward(self, forwardModel='CS', coils=None, noise=0.0,
        ...
        forwardModel : str, optional
            Type of forward model:
                ...
                - Q : Use quadrature. Using FSeq. !!!! Not working !!!
                - QP : Compute Inphase and quadrature using FSeq. 
        ...
        for model, depth in zip(models, depths):
            apps = np.zeros((model.shape[0], len(self.coils)),dtype=dataType)*np.nan
